...
void selfCheck(char turn , char chessboard[][10],  int *selfcheck) {
    ...
    *selfcheck = 0;
    if (turn == 'A') {
        ...
        if (*selfcheck == 0) {
            if ((chessboard[Row + 1][Col + 2] == 'n' && Row + 1 < 8 && Col + 2 < 9)
                || (chessboard[Row + 1][Col - 2] == 'n' && Row + 1 < 8 && Col - 2 > 0)
                || (chessboard[Row + 2][Col + 1] == 'n' && Row + 2 < 8 && Col + 1 < 9)
                || (chessboard[Row + 2][Col - 1] == 'n' && Row + 2 < 8 && Col - 1 > 0)
                || (chessboard[Row - 1][Col + 2] == 'n' && Row - 1 >= 0 && Col + 2 < 9)
                || (chessboard[Row - 1][Col - 2] == 'n' && Row - 1 >= 0 && Col - 2 > 0)
                || (chessboard[Row - 2][Col + 1] == 'n' && Row - 2 >= 0 && Col + 1 < 9)
                || (chessboard[Row - 2][Col - 1] == 'n' && Row - 2 >= 0 && Col - 1 > 0))
                *selfcheck = 1;
        }
        if (*selfcheck == 0) {
            if ((chessboard[Row + 1][Col] == 'k' && Row + 1 < 8)
                || (chessboard[Row - 1][Col] == 'k' && Row - 1 >= 0)
                || (chessboard[Row][Col + 1] == 'k' && Col + 1 < 9)
                || (chessboard[Row][Col - 1] == 'k' && Col - 1 > 0)
                || (chessboard[Row - 1][Col - 1] == 'k' && Row - 1 >= 0 && Col - 1 > 0)
                || (chessboard[Row - 1][Col + 1] == 'k' && Row - 1 >= 0 && Col + 1 < 9)
                || (chessboard[Row + 1][Col + 1] == 'k' && Row + 1 < 8 && Col + 1 < 9)
                || (chessboard[Row + 1][Col - 1] == 'k' && Row + 1 < 8 && Col - 1 > 0))
                *selfcheck = 1;
        }
    }
    if (turn == 'B') {
